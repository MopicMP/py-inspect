...
> Inspect Python objects in detail

[![PyPI version](https://badge.fury.io/py/py-inspect.svg)](https://pypi.org/project/py-inspect/)
...
# Basic usage
result = inspect("your input here")
print(result)
```
...
result = inspect("Hello World")

# Example 2: Batch processing
from py_inspect import batch
